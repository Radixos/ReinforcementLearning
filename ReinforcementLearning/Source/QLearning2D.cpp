...
QLearning2D::QLearning2D(int startState, int maxRepetition, int maxEpisode, bool useQLambda)
{
...
void QLearning2D::DisplayInfo(int maxEpisode, int maxRepetition)
{
...
int QLearning2D::rc2state(int r, int c)
{
...
void QLearning2D::state2rc(int state, bool ifNextState)
{
	if (ifNextState)
	{
...
int QLearning2D::getState(int currentState, int action)
{
